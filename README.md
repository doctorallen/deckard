...
- A broad search is shown a page at a time, 200 notes and 200 tasks to a page, with **Previous**, **Next**, and the page numbers under each list, and the range it is showing, such as *201–400 of 1,880*. Notes and tasks are paged separately. The counts beside Notes and Tasks, the Refine counts, and the filtering you do by typing in the search box are all of the whole search, never of the page. Changing the search, or the Open/Done filter, returns to the first page, and a search that shortens while its last page is open moves you back to the last page it still has.

...
/**
 * A question mark, for Help. Solid like the settings and task-board glyphs,
 * so a toolbar reads as one set, and drawn in whatever color the theme gives
 * the control it sits in.
 */
export const helpIcon =
  '<svg class="toolbar-icon help-icon" viewBox="-5.5 0 19 19" fill="currentColor" aria-hidden="true" focusable="false">' +

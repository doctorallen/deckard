...
---</code></pre>
    ...
    <section id="connections">
      ...
      <div class="cards">
        <div class="card"><h3>Related Notes</h3><p>With a Markdown note active, the sidebar suggests notes that seem to be about the same work. Shared tags are the clearest match; associated tags, Wiki links, and meaningful shared words can also help Deckard find useful connections. Each result's percentage is a relevance estimate, not a measure of completeness: a higher percentage means Deckard found more or stronger reasons to suggest it. Hover the percentage to see those reasons. Use its sort control to choose <strong>Most tags</strong>, <strong>Newest</strong>, <strong>Oldest</strong>, or <strong>Most accessed</strong>. Date sorts use note modification time; access counts are stored locally. Matching tag chips open their tag overviews. When a Tag Overview is active, the sidebar instead shows its associated tags, while its matching notes omit a redundant 100% score. You can turn off automatic keyword matching in Settings.</p></div>

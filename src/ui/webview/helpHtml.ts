...
---</code></pre>
    ...
    <section id="connections">
      ...
      <div class="cards">
        ...
        <div class="card"><h3>Wiki links</h3><p>Write <code>[[Project Neon Relay]]</code> to link a note by filename, or <code>[[Project Neon Relay#Decision]]</code> to link one of its headings. A note&apos;s <code>aliases:</code> front matter gives it other names that links can use. Completion suggests note titles; Cmd/Ctrl-click opens a unique matching note. Hover a link to preview what it points at.</p></div>

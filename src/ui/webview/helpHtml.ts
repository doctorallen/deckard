...
---</code></pre>
    ...
    <section id="connections">
      ...
      <div class="cards">
        ...
        <div class="card"><h3>Stats</h3><p>Run <code>Deckard: Show Stats</code> for index totals and local view counts for tags, entities, and note entries. Select a counted tag to open its overview, or a note entry to open its note. It also lists the notes nothing links to, leaving out daily notes.</p></div>
      </div>
    </section>

...
---</code></pre>
    ...
    <section id="tasks">
      ...
      <div class="cards">
        ...
        <div class="card"><h3>Home</h3><p><strong>Home</strong> is made of widgets you choose: a search box that opens a search page, the tasks a search finds, the Agenda, favorite and frequent tags, saved searches and their results, recent searches, recently opened notes, and workspace totals. Each widget links to where its entries live, such as the Task board or a search page. Choose <strong>Customize</strong> in the View options gear to arrange them: drag a widget to move it, or right-click it to move it first or last; switch it between half and full width; open its own gear to choose how many entries it lists, or the search a tasks widget runs; remove it with <strong>×</strong>; and add more from <strong>+ Add widget</strong>. <strong>Reset</strong> restores the widgets Home started with, and <strong>Done</strong> finishes.</p></div>

...
---</code></pre>
    ...
    <section id="advanced">
      ...
      <div class="cards">
        ...
        <div class="card"><h3>Note and task title tags</h3><p><code>deckard.tagTitleDisplayMode</code> defaults to <code>inline</code>, keeping source tags in related-note and tag-overview note and task titles as clickable buttons. Dashboard task titles also expose their source tags as clickable buttons. Set it to <code>separate</code> to pull overview tags out into dedicated controls after each title.</p></div>

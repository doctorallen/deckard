...
---</code></pre>
    ...
    <section id="advanced">
      <h2>Settings</h2>
      <div class="cards">
        <div class="card"><h3>Choose a theme</h3><p><code>deckard.theme</code> defaults to <code>replicant</code>. Choose <code>oblivion</code>, <code>lcars</code>, or <code>vscode</code> to restyle all Deckard views.</p></div>

...
---</code></pre>
    ...
    <section id="connections">
      ...
      <div class="cards">
        ...
        <div class="card"><h3>Find</h3><p>Run <code>Deckard: Find</code> for results as you type: titles first, then the notes that mention your words, ranked by relevance. Choose <strong>Show all</strong> to see every result on the Dashboard's Notes tab.</p></div>

...
main { border-color: var(--line); box-shadow: inset 0 0 0 1px rgba(118, 255, 99, .14), 0 0 22px rgba(41, 165, 47, .08); }
...
main { border-color: var(--slate-border); box-shadow: inset 0 0 0 1px rgba(85, 113, 61, .24); }
